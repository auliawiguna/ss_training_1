                        ...
                        <div class="item active">
                            ...
                            <div class="container">
                                <div class="carousel-caption">
                                    ...
                                    <p>Shorter your URL, easier for your user to notice it</p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="container">
                                <div class="carousel-caption">
                                    ...
                                    <p>All of your links are protected by strong encryption.</p>
                                </div>
                            </div>
                        </div>
                    </div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<button type="submit" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-success btn-block">Sign In</button>
											</div>
										</div>
									</div>
                                {!!\Form::close()!!}
